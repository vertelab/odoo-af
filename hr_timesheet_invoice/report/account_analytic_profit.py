    ...
    def _line(self, form, journal_ids, user_ids):
        ...
        for line in line_obj.browse(self.cr, self.uid, ids):
            if line.account_id.pricelist_id:
                ...
                price = price_obj.price_get(self.cr, self.uid, [pl], line.product_id.id, line.unit_amount or 1.0,
            ...
            if line.invoice_id:
                ...
                for lid in self.cr.fetchall():
                    ...
                    price = price_obj.price_get(self.cr, self.uid, [pl], lid2.product_id.id, lid2.unit_amount or 1.0,
